...
<body>
    ...
    $query = "SELECT (CASE WHEN CORNER_ORDER.CORNERNAME IS NULL THEN '합계'
    ELSE CORNER_ORDER.CORNERNAME
    END) AS 코너이름, MENU.MENU_NAME 메뉴이름, COUNT(DISTINCT CORNER_ORDER.ORDER_NUM) 주문건수
