...
<body>
    ...
    $query = "SELECT CORNER.CORNER_ID AS 코너 , CORNER.CORNER_NAME AS 코너이름, SUM(MENU.CUSTOMER_PRICE - MENU.ORIGINAL_PRICE) AS 순수익
    FROM CORNER, MENU
    WHERE CORNER.CORNER_ID = MENU.C_ID
    GROUP BY CORNER.CORNER_ID, CORNER.CORNER_NAME, CORNER.CORNER_ID
    ORDER BY SUM(MENU.CUSTOMER_PRICE - MENU.ORIGINAL_PRICE)";
